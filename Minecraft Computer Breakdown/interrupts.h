...
//	const Interrupt NMInterrupt{ 2, Type::None, "" }; // Nonmaskable external Interrupt
...
//	const Interrupt FloatingPointCoprocessorError{ 9, Type::Fault, "" };
	...
	const Interrupt GeneralProtection{ 13, Type::Fault, "#GP" }; // General Proctection
...
//	const Interrupt MachineError{ 18, Type::Abort, "#MC" }; // Machine check
	...
	/**
	 * @brief Descriptor stored in the IDT, describing the privilege level of the interrrupt and where to find its handler
	*/
